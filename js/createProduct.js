...
export const createProduct = (item) => {
  const { api_featured_image, name } = item;
  ...
  img.src = api_featured_image
    ? api_featured_image
    : "https://res.cloudinary.com/hapiii/image/upload/v1667586987/HYF/jof1wxcerlhzyuqufrxl.jpg";
  ...
  productName.textContent = name.trim().substring(0, 12) + "...";
